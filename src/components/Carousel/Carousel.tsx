...
export function StartpageCarousel() {
   ...
   return (
      <Carousel className="mb-2">
         <h1 className="text-center py-2 font-bold text-2xl ">Popular upcoming events</h1>
         <CarouselContent>
                  ...
                  <div className="flex items-center justify-center flex-col">
                     <Card className="bg-slate-100">
                        <CardContent className="flex items-center aspect-square  justify-between flex-col h-48 bg">
                           <img src={event.images[0]} alt={`${event.title} thumbnail`} className="text-xs text-center rounded-lg  mt-2 max-h-32 " />
